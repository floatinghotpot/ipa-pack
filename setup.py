...
#from ipa-pack.version import __version__
lines = open(here + '/ipa_pack/version.py', mode='r').readlines()
for line in lines:
...
setuptools.setup(
    ...
    url = 'https://github.com/floatinghotpot/ipa-pack',
    download_url = 'https://github.com/floatinghotpot/ipa-pack',
    ...
    entry_points={'console_scripts': ['ipa-pack=ipa_pack:cli_main']},
